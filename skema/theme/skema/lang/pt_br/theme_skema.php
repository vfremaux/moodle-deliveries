...
$string['programvalue3'] = 'Program Value 3';
$string['programvalue4'] = 'Program Value 4';
$string['programvalue5'] = 'Program Value 5';
$string['programvalue6'] = 'Program Value 6';
$string['programvalue7'] = 'Program Value 7';
$string['programvalue8'] = 'Program Value 8';
$string['programvalue9'] = 'Program Value 9';
$string['programvalue10'] = 'Program Value 10';

$string['skprogramimage1'] = 'Program Image 1';
$string['skprogramimage2'] = 'Program Image 2';
$string['skprogramimage3'] = 'Program Image 3';
$string['skprogramimage4'] = 'Program Image 4';
$string['skprogramimage5'] = 'Program Image 5';
$string['skprogramimage6'] = 'Program Image 6';
$string['skprogramimage7'] = 'Program Image 7';
$string['skprogramimage8'] = 'Program Image 8';
$string['skprogramimage9'] = 'Program Image 9';
$string['skprogramimage10'] = 'Program Image 10';


$string['menuhome'] = 'Página Inicial';
