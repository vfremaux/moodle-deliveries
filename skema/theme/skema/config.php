...
// Esta configuração define o arquivo scss principal para o nosso tema ser compilado. Poderíamos configurá-lo para um arquivo estático na pasta scss ou para uma função que retorna o SCSS com base nas configurações do tema. 
...
$THEME->prescsscallback = 'theme_skema_get_pre_scss';


$THEME->extrascsscallback = 'theme_skema_get_extra_scss';
